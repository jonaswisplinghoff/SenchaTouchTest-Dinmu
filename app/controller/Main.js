Ext.define('testApp.controller.Main', {
    ...
    * testApp.utils.Functions.loadData() for loading the weather data.
    ...
    */
     onRefresh: function() {
        ...
        var model = Ext.create("testApp.model.Setting", {});
        ...
        if (model.get('geo') !== true && errors.isValid() === false) {
            ...
            store.sync();
            testApp.utils.Functions.loadData();
        }
